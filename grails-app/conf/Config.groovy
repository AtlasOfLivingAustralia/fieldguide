...
if (new File(default_config).exists()) {
    log.info "[${appName}] Including default configuration file: " + default_config;
    grails.config.locations.add "file:" + default_config
} else {
    log.error "[${appName}] No external configuration file defined."
}

log.info "[${appName}] (*) grails.config.locations = ${grails.config.locations}"
log.info "default_config = ${default_config}"
