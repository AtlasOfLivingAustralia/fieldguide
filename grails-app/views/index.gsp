...
<html>
    ...
    <body>
        ...
        <p>
            <textarea rows="8" cols="120">
            {"status":"running","statusUrl":"https://fieldguide.ala.org.au/status/23092022-fieldguide1663911782972.pdf"}
            </textarea>
        </p>
        ...
        <p>
            <textarea rows="8" cols="120">
            {"status":"finished","downloadUrl":"https://fieldguide.ala.org.au/download/23092022-fieldguide1663911782972.pdf"}
            </textarea>
        </p>
    </body>
</html>
